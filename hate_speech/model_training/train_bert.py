...
if __name__ == '__main__':
    ...
    result_report_macro_df = class_report(y_true=np.concatenate(eval_df[['labels']].to_numpy(), axis=0), y_pred=pred,
                                 y_score=scores, average='macro')
